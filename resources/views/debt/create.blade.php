    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-gray-200/60 shadow-sm">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <h1 class="text-lg font-bold text-slate-900">Yangi Qarzdor</h1>
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 sm:p-8">
                <form action="{{ route('debt.store') }}" method="POST" class="space-y-6">
                    @csrf

                    <!-- Ism Familiya -->
                    <div>
                        <x-form.input type="text" name="name" placeholder="Masalan: Teshaboyev Boltaboy"
                                      icon="fa-regular fa-user" label="To'liq ism (F.I.O)"/>
                    </div>
                    ...
                    <!-- Summa -->
                    <div>
                        <x-form.input type="number" name="amount" placeholder="0"
                                      icon="fa-solid fa-money-bill-wave" label="Qarz miqdori (so'm)"/>
                    </div>
